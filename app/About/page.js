...
const About = () => {
  return (
    <Layout>
      <div className="flex flex-col items-start justify-start h-screen p-8 mx-10 text-gray-800">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex flex-col gap-2 ml-64 w-1/2">
        ...
        <div className="flex gap-4 mt-10">
          <div className="flex flex-col gap-4 w-1/2 border-2 border-gray-300 p-4 rounded-lg">
